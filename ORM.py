...
engine = create_engine(
    'postgresql://amrit:1234@localhost:5432/crimes_in_boston')
...
def insert_data():
    crimes_df = pd.read_csv('DATA/crimes.csv', encoding='windows-1252')
    ...
    police_district_codes_df.to_sql('police_district_codes',
